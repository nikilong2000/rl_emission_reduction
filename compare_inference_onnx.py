    ...
    try:
        ...
        with Timer() as t_onnx:
            for i in range(len(data)):
                ...
                drv_input = np.array([[data[i, 0], torque, data[i, 4], data[i, 5]]], 
                                    dtype=np.float32)
