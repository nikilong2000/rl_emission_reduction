...
def get_scaler(ruta_model, tipus="input"):
    ...
    if tipus == "input":
        ...
        raise ValueError("Parameter 'tipus' must be 'input' or 'output'")
...
class transition_function_model:
    ...
    def reset_models(self):
        """
        Resets internal states of ICE and PG (if they have reset_states),
        and returns auxiliary initial states as TF tensors.
        """
    ...
    # ---------- complete flow (no logic changes) ----------
    def predict(
        self,
        Speed_rpm,
        m_fuel_mg,
