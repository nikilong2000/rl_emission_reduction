import numpy as np
import pandas as pd  # ← I leave it because the rest of the file uses it
...
def get_model(ruta_modelo):
    ...
    try:
        ...
        raise FileNotFoundError(f"Model not found in '{ruta_completa}': {e}") from e
...
class transition_function_model:
    def __init__(
        ...
        # ======= MinMaxScaler parameters as tensors =======
