...
def evaluate_model(
    ...
    resolved_model_path = resolve_model_path(model_path)
    print(f"Loading PyTorch TorchRL recurrent SAC model from {resolved_model_path}...")
    agent, _ = TorchRLRecurrentSACAgent.load_for_evaluation(
    ...
    plot_state_visitation_1d([eval_results], ["PyTorch_SAC"], log_dir)
    plot_state_visitation_2d(eval_results, log_dir)
    plot_action_distribution([eval_results], ["PyTorch_SAC"], log_dir)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluate a trained PyTorch TorchRL recurrent SAC model."
    )
    parser.add_argument(
