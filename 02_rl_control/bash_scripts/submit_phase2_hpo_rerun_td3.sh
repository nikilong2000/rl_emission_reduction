#!/bin/bash
#SBATCH --job-name=phase2_rerun_td3
...
# ============================================================================
# TD3 PHASE-2 HPO RERUN — rerun every non-COMPLETE trial in the TD3 study
# ============================================================================
# Reads journal at logs/td3/phase2_optuna/study_journal.log.
...
python 02_rl_control/hyperparameter_search/rerun_phase2_trial.py \
    ...
    --agent_device "$DEVICE"
echo ""
echo "TD3 rerun finished at $(date '+%Y-%m-%d %H:%M:%S')"
